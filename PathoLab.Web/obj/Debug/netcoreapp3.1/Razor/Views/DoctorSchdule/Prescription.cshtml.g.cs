#pragma checksum "D:\testcode\patholab\updatedPatholab\Patholab\Patholab\lab - Copy\PathoLAb\PathoLab.Web\Views\DoctorSchdule\Prescription.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "ceaed377041e0e8a6721d11b6bab04ba8d1fda76af3abfe8d938541b0013ce36"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_DoctorSchdule_Prescription), @"mvc.1.0.view", @"/Views/DoctorSchdule/Prescription.cshtml")]
...
#nullable disable
#nullable restore
#line 2 "D:\testcode\patholab\updatedPatholab\Patholab\Patholab\lab - Copy\PathoLAb\PathoLab.Web\Views\DoctorSchdule\Prescription.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA256", @"ceaed377041e0e8a6721d11b6bab04ba8d1fda76af3abfe8d938541b0013ce36", @"/Views/DoctorSchdule/Prescription.cshtml")]
    ...
    #nullable restore
    public class Views_DoctorSchdule_Prescription : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<PathoLab.Domain.DignosisMaster.Dignosis>
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 5 "D:\testcode\patholab\updatedPatholab\Patholab\Patholab\lab - Copy\PathoLAb\PathoLab.Web\Views\DoctorSchdule\Prescription.cshtml"
        ...
        <div class=""card"">
            <div class=""card-header"">
                <ul class=""nav nav-tabs nav-fill"" role=""tablist"">                    
                    <a class=""nav-item nav-link active "">Prescription</a>
                </ul>

                <div class=""indicatorslist"">
                    <a onclick=""updateDepartment()"" id=""backIcon"" data-toggle=""tooltip"" data-placement=""top"" data-original-title=""Back""><i class=""icon-arrow-left1""></i></a>
 ");
            WriteLiteral("                   <p class=\"ml-2\">Appointments </p>\r\n                </div>\r\n               \r\n            </div>\r\n            <!--===================================================-->\r\n");
            WriteLiteral(@"            <!-- BASIC FORM ELEMENTS 1 -->
            <!--===================================================-->
            <div class=""card-body"">
                <!--Static-->
...
");
            ...
            BeginWriteAttribute("value", " value=\"", 2242, "\"", 2313, 1);
#nullable restore
#line 62 "D:\testcode\patholab\updatedPatholab\Patholab\Patholab\lab - Copy\PathoLAb\PathoLab.Web\Views\DoctorSchdule\Prescription.cshtml"
WriteAttributeValue("", 2250, HttpContextAccessor.HttpContext.Session.GetInt32("HospitalID"), 2250, 63, false);
...
#nullable disable
            ...
            BeginWriteAttribute("value", " value=\"", 2502, "\"", 2576, 1);
#nullable restore
#line 64 "D:\testcode\patholab\updatedPatholab\Patholab\Patholab\lab - Copy\PathoLAb\PathoLab.Web\Views\DoctorSchdule\Prescription.cshtml"
WriteAttributeValue("", 2510, HttpContextAccessor.HttpContext.Session.GetString("HospitalName"), 2510, 66, false);
...
#nullable disable
            ...
            WriteLiteral(@" />
                    ...
                    <div class=""col-xs-12 col-md-3 col-xl-3"">
                        <label class=""control-label"" for=""DrName""><b>Doctor Name</b></label>
                        <input id=""txtDoctorName"" class=""form-control"" disabled");
            BeginWriteAttribute("value", " value=\"", 2846, "\"", 2916, 1);
#nullable restore
#line 68 "D:\testcode\patholab\updatedPatholab\Patholab\Patholab\lab - Copy\PathoLAb\PathoLab.Web\Views\DoctorSchdule\Prescription.cshtml"
WriteAttributeValue("", 2854, HttpContextAccessor.HttpContext.Session.GetString("UserName"), 2854, 62, false);
            ...
            <div class=""card-body"">
                <div class=""form-group row"">
                    <div class=""col-12 col-md-4 col-xl-4"">
                        ...
                        <input type=""text"" id=""txtBloodPressure"" class=""form-control"" onchange=""BPvalidate('txtBloodPressure','llbError')"" />
                        <span id=""llbError"" style=""color:red""></span><br />
                        <label class="" control-label"" for=""Height""> <b> Height </b></label>
                        <input type=""text"" id=""");
            WriteLiteral(@"txtHeight"" class=""form-control"" />
                        <label class="" control-label"" for=""Weight""> <b> Weight </b></label>
                        <input type=""text"" id=""txtWeight"" class=""form-control"" />
                        <label class=""control-label"" for=""OxygenLevel""> <b>Oxygen Level</b> </label>
                        <input type=""text"" id=""txtOxygenLevel"" class=""form-control"" onchange=""Oxyvalidate('txtOxygenLevel', 'llbErroroxy')"" />
                        <span id=""llbErroroxy"" style=""color:red""></span><br />
                    ...
                    <div class=""col-12 col-md-8 col-xl-8"">
                        <label clas");
            WriteLiteral(@"s=""control-label"" for=""Symptoms""><b>Symptoms</b>  </label>
...
");
            ...
            WriteLiteral(@"br />
                ...
                <div class=""form-group row"">
      ");
            WriteLiteral(@"              <label class=""col-12 col-md-2 col-xl-2 control-label""></label>
                    <div class=""col-12 col-md-6 col-xl-4"">
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ceaed377041e0e8a6721d11b6bab04ba8d1fda76af3abfe8d938541b0013ce3617030", async() => {
            }
            );
...
<script type=""text/javascript"">
    ...
    //< !--=================================================== -->
    function reset() {
        window.location.href = ""/DoctorSchdule/Appointments"";
    }
    //< !--=================================================== -->
    //Medicine AutoFill
            ...
            $(this).find(""td"").eq(0).find(""#txtMedicineName"").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        dat");
            WriteLiteral(@"a: { ""prefix"": request.term },
                        type: ""POST"",
    ...
    $(document).on('change', '.inputs', function () {
        $('#tblMedicine tbody tr').each(function (index) {
            var row = this;
            $(thi");
            WriteLiteral(@"s).find(""td"").eq(0).find(""#txtMedicineName"").blur(function () {
                $.ajax({
    ...
    //< !--=================================================== -->
    //DataBind From Appointment Table
    function BindPatientDetails(PatientID) {
        $.ajax({
            url: ""/DoctorSchdule/GetPatientDetailsByPatientID?PatientID="" + PatientID,
            typr: ""GET"",
            contentType: ""application/json;charset=UTF-8"",
            dataType: ""json"",
            success: function (result) {
                $('#hdnPatientID').val(result[0].PatientID);
                $('#txtName').val(result[0].FullName);
                $('#txtHospitalName').val(result[0].HospitalName);
                $('#txtRegdNo').val(result[0].RegdNo);
                $('#txtDate').val(result[0].DateOfAppointment);
    ...
    function updateDepartment() {
        location.href = ""/DoctorSchdule/Appointments"";
    }
        //< !--=================================================== -->
    //Create
    $(""#btnSubmit"").click(function () {
        ...
        for (var i = 0; i < tbl.rows.length; i++) {
            ...
            item1.Duration = tbl.rows");
            WriteLiteral(@"[i].children[2].children[0].value;
        ...
        //entity.BloodPressu");
            WriteLiteral(@"re = $(""#txtBloodPressure"").val();
        ...
        //    GuardianName: $(""#txtHFMName"").val(),
        //    Height: $(""#txtHeight"").val(),
        //    Weight: $(""#txtWeight"").val(),
        //    BloodPressure: $(""#txtBloodPressure"").val(),
        //    OxygenLevel: $(""#txtOxygenLevel"").val(),
        //    Symptoms: $(""#txtSymptoms"").val(),
        //    PatientHistory: $(""#txtHistory"").val(),
        //    OtherAdvice: $(""#txtOtherAdvice"").val(),
        //    DignosisCommaSepareted: selected.join("", ""),
        //};
        if (validate()) {
            if (confirm(""Are you sure you want to Submit ?"")) {
                $.ajax({
               ");
            WriteLiteral(@"     url: ""/DoctorSchdule/CreatePrescription"",
                    data: entity,
                    type: ""POST"",
                    success: function (result) {
    ...
    //Dropdown data bind
    function GetDig");
            WriteLiteral(@"nosisOfEachDropdownById(id) {
        $.ajax({
    ...
    //< !--=================================================== -->
    //Medicine Adding
    //$(""#rowAdding"").click(function () {
    //    newRowAdding =
    //        '<div id=""row""> <div class=""input-group m-3""><input type=""text"" class=""form-control m-input"">' +
    //        '<div class=""input-group-prepend"">' +
    //        ");
            WriteLiteral(@"'<button class=""btn btn-danger"" id=""DelRow"" type=""button"">' +
    //        '<i class=""fa fa-trash-o""></i></button> </div>' +
    //        '</div> </div>';
    //    $('#newinputs').append(newRowAdding);
    //});
    ...
    // Dignosis Name  Data Bind
    function GetDignosis() {
        $.ajax({
            url: ""/DoctorSchdule/GetDignosis"",
            type: ""GET"",
            success: function (result) {
            ...
            error: function (error) {
                jsonValue = jQuery.parseJSON(error.r");
    ...
    $('#addBtn').on('click', function () {
        ...
        $('#tbody').append(`<tr id=""R${++rowIdx}"">
             ...
             <input id=""txtMedicineName"" class=""inputs form-control m-input""><input type=""hidden"" id=""hdnMedicineId"" class=""form-control m-input"">
              ...
              <td class=""row-index text-center"">
              <input id=""txtDuration"" type=""text"" maxlength = ""100"" size = ""8""class=""form-co");
            WriteLiteral(@"ntrol m-input"">
             </td>
    ...
    function validate() {
        if ($('#txtHFMName').val() == """") {
            alert(""Please Enter gurdian Name!"");
            $('#txtHFMName').focus();
            return false;

        }
       else if ($('#txtBloodPressure').val() == """") {
            alert(""Please Enter BloodPressure !"");
            $('#txtBloodPressure').focus();
            return false;
        }
        
        else if ($('#txtHeight').val() == """") {
        ...
        } else if ($('#txtOxygenLevel').val() == """") {
            alert(""Please Enter OxygenLevel !"");
            $('#txtOxygenLevel').focus();
            return false;

        } else if ($('#txtPulse').val() == """") {
            alert(""Please Enter Pulse rate!"");
            $('#txtPulse').focus();
            return false;

        } else if ($('#txtTemperature').val() == """") {
            alert(""Please Enter BodyTemperature!"");
            $('#txtTemperature').focus();
            return false;

        } else if ($('#txtHistory').val() == """") {
            alert(""Please Enter Patient's history!"");
            $('#txtHistory').focus();
            return false;

        } else if ($('#ddlDignosis').val() == 0) {
            alert(""Please select your Diognesis!"");
            $('#ddlDignosis').focus();
            return false;

        } else if ($('#txtOtherAdvice').val() == """") {
            alert(""Please Enter otherAdvise!"");
  ");
            WriteLiteral(@"          $('#txtOtherAdvice').focus();
            return false;

        //} else if ($('#tblMedicine').val() == """") {
        //    alert(""Please Enter Data!"");
        //    $('#tblMedicine').focus();
        //    return false;

        //} else if ($('#newinput').val() == """") {
        //    alert(""Please Enter Diognesis !"");
        //    $('#newinput').focus();
        //    return false;
